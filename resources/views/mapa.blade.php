...
<!--    <script src="--><?//=base_url()?><!--dist/leaflet.awesome-markers.js"></script>-->
    ...
    <link rel="stylesheet" href="assets/css/leaflet.extra-markers.css">
    <script src="assets/js/leaflet.extra-markers.js"></script>
...
<div id='map'></div>
<img src="img/oruro.png" id="logooruro" alt="" width="50">
<!--<img src="--><?//=base_url()?><!--img/uto.png" id="logouto" alt="" width="50">-->
<label for="" style="font-weight: bold;color: #002166" id="titulo"><b>GETRAG</b> <span style="font-size:14px;"> Geolocalizacion en Tiempo Real de Automoviles GAMO</span></label>
<script>
    window.onload=function (){
        ...
        datos();
        setInterval(function(){ datos(); }, 5000);
        ...
        function datos(){
            lugares.clearLayers();
            $.ajax({
                url:'http://localhost:8000/api/ultimo',
                success:function (e){
                    console.log(e);
                    //return false;
                    let dat=e;
                    ...
                    dat.forEach(r=>{
                        ...
                        var html='<table border="1">' +
                            '<tr><td><b>Camion:</b></td><td>'+r.camion+' </td></tr>' +
                            '</table>'
